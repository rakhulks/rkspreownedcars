...
<table class="Seller">
	<thead>
		...
		<tr>
			...
			<td><a href="editSeller?supplierId=${supplier.supplierId}"><span
									class="glyphicon glyphicon-pencil"></span></a></td>
			<td><a href="deleteSeller?supplierId=${supplier.supplierId}"onclick="return confirm('Are You Sure? Do you Want Delete this Seller : ${supplier.supplierName} ?')"><span
